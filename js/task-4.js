...
const pricePerDroid;
pricePerDroid = 3000;
let totalPrice=priceDroid*pricePerDroid;
let priceDroid = prompt ('количество дроидов которые вы хотите купить');
if (priceDroid === null){ console.log ('Отменено пользователем!')
} 
else if (totalPrice>credits){console.log('Недостаточно средств на счету!')
} 
else (totalPrice<credits); {console.log(`Вы купили ${priceDroid} дроидов, на счету осталось ${credits - totalPrice} кредитов.`)}